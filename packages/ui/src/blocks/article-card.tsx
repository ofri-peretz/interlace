 ...
 * `@interlace/ui/patterns/article-card`. Moved as part of the
 * 5-layer DS architecture (Phase 1). This alias is a one-line re-export so
 * existing consumers (`import { ... } from '@interlace/ui/blocks/article-card'`)
 ...
 */
export * from '../patterns/article-card.js';
