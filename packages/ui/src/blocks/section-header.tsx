 ...
 * `@interlace/ui/patterns/section-header`. Moved as part of the
 * 5-layer DS architecture (Phase 1). This alias is a one-line re-export so
 * existing consumers (`import { ... } from '@interlace/ui/blocks/section-header'`)
 ...
 */
export * from '../patterns/section-header.js';
