/**
 * @deprecated Moved to `@interlace/ui/patterns/author-byline` as part of the
 * 5-layer DS architecture (Phase 1). This alias is a one-line re-export so
 * existing consumers (`import { ... } from '@interlace/ui/blocks/author-byline'`)
 ...
 */
export * from '../patterns/author-byline.js';
