 ...
 * `@interlace/ui/patterns/prev-next-post`. Moved as part of the
 * 5-layer DS architecture (Phase 1). This alias is a one-line re-export so
 * existing consumers (`import { ... } from '@interlace/ui/blocks/prev-next-post'`)
 ...
 */
export * from '../patterns/prev-next-post.js';
