 ...
 * `@interlace/ui/patterns/code-window`. Moved as part of the
 * 5-layer DS architecture (Phase 1). This alias is a one-line re-export so
 * existing consumers (`import { ... } from '@interlace/ui/blocks/code-window'`)
 ...
 */
export * from '../patterns/code-window.js';
