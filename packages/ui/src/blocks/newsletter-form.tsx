 ...
 * `@interlace/ui/patterns/newsletter-form`. Moved as part of the
 * 5-layer DS architecture (Phase 1). This alias is a one-line re-export so
 * existing consumers (`import { ... } from '@interlace/ui/blocks/newsletter-form'`)
 ...
 */
export * from '../patterns/newsletter-form.js';
