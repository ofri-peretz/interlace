---
"@interlace/foundation": minor
---

Initial public release. CSS-only npm proof of the Interlace design-system contract — five stylesheets distributed as plain CSS for any framework:
