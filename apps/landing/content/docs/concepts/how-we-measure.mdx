...
| ------------------------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `eslint-plugin-*`         | [eslint/packages/benchmarks/](https://github.com/ofri-peretz/eslint/tree/main/packages/benchmarks) | [eslint.interlace.tools/docs/concepts/how-we-measure](https://eslint.interlace.tools/docs/concepts/how-we-measure)         |
