    ...
    <div className="bg-background text-foreground min-h-screen">
      ...
      <main className="mx-auto max-w-prose px-6 py-16">
        ...
        <p className="text-muted-foreground mt-3 max-w-prose text-lg">
          ...
          cascade-layer model behind it, and the override surface for forking
          the brand. If you only read one page in this docs, read this.
        </p>
...
@import "@interlace/ui/styles/index.css";`}</code>
          ...
          <p className="text-muted-foreground mt-3 text-sm">
            That barrel resolves to six CSS files imported in cascade-correct
            order. Read on for the why.
          </p>
        </section>
        ...
        <section className="mt-12">
          ...
          <p className="text-muted-foreground mt-2">
            `index.css` declares the layer order up front, so the cascade is
            self-documenting:
          </p>
          <pre className="bg-muted text-foreground mt-4 overflow-x-auto rounded-md p-md font-mono text-sm">
...
@import "./interlace-theme.css";`}</code>
          ...
          <p className="text-muted-foreground mt-4 text-sm">
            Left-to-right in the layer declaration = ascending cascade priority
            (later wins). So{" "}
            <code className="font-mono">interlace.semantics</code> overrides{" "}
            <code className="font-mono">interlace.brand</code>, which overrides
        ...
        <section className="mt-12">
          ...
          <p className="text-muted-foreground mt-2">
            ...
            <code className="font-mono">@layer interlace.brand</code>. Declare
            it AFTER importing index.css and your hex values deterministically
            win — regardless of declaration order or specificity. Without
            cascade layers, brand override is source-order roulette.
          </p>
          <pre className="bg-muted text-foreground mt-4 overflow-x-auto rounded-md p-md font-mono text-sm">
  ...
  .dark {
    ...
    /* ... */
        ...
        <section className="mt-12">
          ...
          <p className="text-muted-foreground mt-2">
            Layers other than <code className="font-mono">interlace.brand</code>{" "}
          ...
          <ul className="mt-3 ml-md list-disc space-y-2 text-sm">
            <li>
              ...
              overriding this loses the WCAG 2.2 SC 2.4.13 focus ring, scrollbar
              tint, and <code className="font-mono">[data-min-viewport]</code>{" "}
              dev-mode outline contract.
            </li>
            <li>
              <code className="font-mono">interlace.bridge</code> — fumadocs ↔
              shadcn token bridge. Touching it breaks cross-framework primitive
              resolution.
            </li>
            <li>
              <code className="font-mono">interlace.primitives</code> +{" "}
              <code className="font-mono">interlace.foundation</code> —
              keyframes, motion timings, type scale, spacing scale. These are
              structural; the brand layer is the authoring seam.
            </li>
          </ul>
        </section>
