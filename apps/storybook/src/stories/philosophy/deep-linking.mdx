...
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: docs/philosophies/DEEP_LINKING_PHILOSOPHY.md
    hash: 79a61db7f4fc */}

# Deep-Linking Philosophy

A focused sub-philosophy of [URL_PHILOSOPHY.md](?path=/docs/philosophy-url--docs) and
[UX_PHILOSOPHY.md](?path=/docs/philosophy-ux--docs), expanding principle #2 ("Every URL is a
