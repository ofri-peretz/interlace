...
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: docs/philosophies/DATA_TABLE_PHILOSOPHY.md
    hash: 42e7b7741029 */}
...
Pairs with [PAGINATION_PHILOSOPHY.md](?path=/docs/philosophy-pagination--docs) (we already
codified URL-state pagination) and [LOADING_PHILOSOPHY.md](?path=/docs/philosophy-loading--docs)
...
query string per [DEEP_LINKING_PHILOSOPHY.md](?path=/docs/philosophy-deep-linking--docs).
...
Cross-link to [PAGINATION_PHILOSOPHY.md](?path=/docs/philosophy-pagination--docs). Tables
...
Cross-link to [LOADING_PHILOSOPHY.md](?path=/docs/philosophy-loading--docs) and
[ERROR_PHILOSOPHY.md](?path=/docs/philosophy-error--docs).
...
Cross-link to [A11Y_PHILOSOPHY.md](?path=/docs/philosophy-a11y--docs).
