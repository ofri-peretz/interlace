...
{/* AUTO-GENERATED — run `npm run sync:philosophies` after editing the source.
    source: docs/philosophies/ERROR_PHILOSOPHY.md
    hash: 64615edf9069 */}
...
Pairs with [LOADING_PHILOSOPHY.md](?path=/docs/philosophy-loading--docs): loading,
...
**Mechanics:** see [LOADING_PHILOSOPHY.md](?path=/docs/philosophy-loading--docs) for the
skeleton contract.
...
**Cross-link:** [LAYOUT_PHILOSOPHY.md](?path=/docs/philosophy-layout--docs) §6 *Reserve
