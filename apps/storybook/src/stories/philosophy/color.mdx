...
| Token | Light | Dark | Use |
| --- | --- | --- | --- |
| `fd-primary` | `#8a3a10` (burnt orange) | `#fbb99a` (light burnt orange) | Primary action, brand accent, focus ring |
...
Orange is our accent. That doesn't mean every surface is orange — it
...
- **Shadows become glows.** A `shadow-lg` on a card in light mode
  becomes a soft `shadow-orange-500/10` glow on dark mode. Black
...
- **Brand accent gets brighter.** Orange-600 in light becomes
  orange-400 in dark. Same brand, calibrated for the surface.
